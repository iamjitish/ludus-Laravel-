                            ...
                            <div class="col-lg-6 col-md-8 u-s-m-b-30">
                                <div class="l-f-o">
                                    <div class="l-f-o__pad-box">
                                        ...
                                        <form class="l-f-o__form" action="{{ url('/') }}/logindetails" method="post">
                                            @csrf
                                            <div class="gl-s-api">
                                                <div class="u-s-m-b-15">
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <input class="input-text input-text--primary-style" name="password" type="text" id="login-password" placeholder="Enter Password">
                                                <span class="text-danger">
                                                    @error('password')
                                                        {{ $message }}
                                                    @enderror
                                            ...
                                            <div class="gl-inline">
                                                ...
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <a class="gl-link" href="{{url('/')}}/lost-password">Lost Your Password?</a></div>
                                            </div>
                                            <div class="u-s-m-b-30">
